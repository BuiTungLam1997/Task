...
<c:url var="APIurl" value="/api/group"/>
<c:url var="UserGroupAPIurl" value="/api/user-group"/>
<c:url var="GroupURL" value="/admin-group-list">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <form action="<c:url value="/admin-search-group"/>" method="get" id="formSearch">
                                    <input type="text" placeholder="Search.." name="search" id="search" value="">
                                    <button type="submit" onclick="fun()" id="btnSearch">Submit
                                    </button>
                                </form>

                                <form action="<c:url value="/admin-group-list"/>" id="formSubmit" method="get">
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            <c:url var="createUserURL" value="/admin-group-edit"/>
                                            <a flag="info"
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="item" items="${model.listResult}">
                                            <tr>
                                                ...
                                                <td>${item.note}</td>
                                                <td>
                                                    <c:url var="updateTaskURL" value="/admin-group-edit">
    ...
    function deleteDevice(data) {
        $.ajax({
            ...
            success: function (result) {
                window.location.href = '${GroupURL}&message=delete_success';
            },
            error: function (error) {
                window.location.href = '${GroupURL}&message=error_system';
            },
        });
    }
</script>
