...
<c:url var="APIurl" value="/api/group/user"/>
<c:url var="UserURL" value="/admin-group-user-list"/>
<html>
<head>
...
<div class="main-content">
    <form action="<c:url value="/admin-group-user-list"/>" id="formSubmit" method="get">
