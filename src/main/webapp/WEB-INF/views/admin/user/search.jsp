...
<c:url var="TaskURL" value="/admin-search-user">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                ...
                                <form action="<c:url value="/admin-search-user"/>" id="formSubmit" method="get">
...
<script type='text/javascript' src="/template/custom/admin/js/user/search.js"></script>
</body>
</html>
